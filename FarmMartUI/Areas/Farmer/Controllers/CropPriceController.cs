...
{
    public class CropPriceController : SuperBaseController
    {
        private IRepositoryService<CropPrice> CropPriceService;
        private IRepositoryService<FarmCrop> FarmCropService;

        public CropPriceController(IRepositoryService<CropPrice> cropPriceService, IRepositoryService<FarmCrop> farmCropService)
        {
