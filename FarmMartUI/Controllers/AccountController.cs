...
namespace FarmMartUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private ActionResult RedirectToLocal(string returnUrl, string userMail)
        {
            if (Url.IsLocalUrl(returnUrl))
            {
                return Redirect(returnUrl);
            }
            bool isBuyer = ((from user in db.Users
                            where user.UserName == userMail
                            select new
                            {
                            ...
                            }).First().RoleName.Name == "Buyer" )? true : false;
            ...
            if (!isBuyer)
                ...
                return RedirectToAction("AddAddress", "Consumer", new { area = "Consumer" });
